// /functions/auth/parent.js
// Cloudflare Pages Function
// Proxies:  /auth/parent  ->  https://cms-policy-worker.shokbhl.workers.dev/auth/parent
...
export async function onRequest(context) {
  ...
  const target = new URL(WORKER_ORIGIN + "/auth/parent");
  ...
  if (request.method !== "POST") {
    return json(
      { ok: false, error: "Method Not Allowed. Use POST /auth/parent" },
      405,
      request
    );
  }
